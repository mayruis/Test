                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                         <?php 
                              ...
                              $mode1="select * from profile where Profile_name = 'Indian River' and profile_W = '1' ";
                              $modeQuery1 = mysql_query($mode1)or die ("Error Query1 [".$mode1."]");
                        ...
                        <img alt="เธฃเธนเธ�" src="http://www.lib.ru.ac.th/journal/images/cock-1.jpg">
                          ...
                          <br><br>
                           ...
                           <input name="namemode" id="namemode" value="IndianRiver" class="hidden">
                              ...
                              $mode2="select * from profile where Profile_name = 'Indian River' and profile_W = '2' ";
                             ...
                             $modeResult2 = mysql_fetch_array($modeQuery2);
                              ...
                              $mode3="select * from profile where Profile_name = 'Indian River' and profile_W = '3'";
                             ...
                             $modeResult3 = mysql_fetch_array($modeQuery3);
                              ...
                              $mode4="select * from profile where Profile_name = 'Indian River' and profile_W = '4'";
                              $modeQuery4 = mysql_query($mode4)or die ("Error Query4 [".$mode4."]");
                             $modeResult4 = mysql_fetch_array($modeQuery4);
                              ...
                              $mode5="select * from profile where Profile_name = 'Indian River' and profile_W = '5'";
                             ...
                             $modeResult5 = mysql_fetch_array($modeQuery5);
                              ...
                              $mode6="select * from profile where Profile_name = 'Indian River' and profile_W = '6'";
