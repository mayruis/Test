...
include("connectSQL.php");
 ...
 if($objResult)
 {
 	echo "<script type='text/javascript'>window.location.href = \"/Dropbox/EditTest/pages/select.php \";</script>";
 	exit();
 ...
 else
 {
 	...
 	$strSQL1 = "INSERT INTO profilename (Profile_name,Profile_date) VALUES ('".$_POST['profile_name']."',
		'".$d."')";
 	...
 	{
 		echo "PN save done";
 		$strSQL2 = "INSERT INTO  profile (Profile_id,Profile_name,Profile_temperature,Profile_humidity_min,Profile_humidity_max)
        		VALUES ('',  '".$name."_1',  '".$temp_w1."',  '".$hmin_w1."',  '".$hmax_w1."'),
 		               ('',  '".$name."_2',  '".$temp_w2."',  '".$hmin_w2."',  '".$hmax_w2."'),
 			           ('',  '".$name."_3',  '".$temp_w3."',  '".$hmin_w3."',  '".$hmax_w3."'),
 					   ('',  '".$name."_4',  '".$temp_w4."',  '".$hmin_w4."',  '".$hmax_w4."'),
 		               ('',  '".$name."_5',  '".$temp_w5."',  '".$hmin_w5."',  '".$hmax_w5."'),
 		               ('',  '".$name."_6',  '".$temp_w6."',  '".$hmin_w6."',  '".$hmax_w6."')";
